...
ckpt_path='original/model.pt' #"/storage/combclip/2024_10_23-13_13_57-model_create_uni3d-lr_0.0003-b_48-j_4-p_amp_3pc/epoch_33/mp_rank_00_model_states.pt"

torchrun --nproc-per-node=1 main_scannet_plot.py \
    --model $model \
    --batch-size 16 \
    --npoints 10000 \
    --num-group 512 \
